const I18N = {
  ar: {
    brandName: "Extreme Cyber Security",
    brandSubtitle: "مركز قيادة الدفاع السيبراني المؤسسي",
    poweredByExtreme: "Extreme Technology Company · رام الله",
    ...
    heroEyebrow: "Extreme Technology Company",
    heroTitle: "Extreme",
    heroSuffix: "Cyber Security",
    heroBody: "منصة دفاع سيبراني موحّدة — XDR · SIEM · SOAR · EDR · امتثال · ذكاء اصطناعي · غرفة عمليات.",
    topbarTitle: "غرفة قيادة الأمن السيبراني",
  ...
  en: {
    brandName: "Extreme Cyber Security",
    brandSubtitle: "Enterprise Cyber Defense Command Center",
    poweredByExtreme: "Extreme Technology Company · Ramallah",
    ...
    heroTitle: "Extreme",
    heroSuffix: "Cyber Security",
    heroBody: "Unified cyber defense — XDR · SIEM · SOAR · EDR · compliance · AI · SOC operations.",
    topbarTitle: "Cyber Security Operations Center",
    badgeAI: "Neural Cortex",
