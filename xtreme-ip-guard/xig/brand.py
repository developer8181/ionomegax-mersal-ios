...
BRAND = {
    ...
    "tagline_en": "Unified EDR · SIEM · SOAR · VM · GRC · AI — enterprise alternative in one suite",
    "tagline_ar": "بديل متكامل — EDR · SIEM · SOAR · ثغرات · امتثال · ذكاء اصطناعي في منصة واحدة",
